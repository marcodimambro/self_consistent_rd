...
params = dict(
    ...
    eps_x = -0.0, eps_y = -0.0, eps_xy = 0.3,
    ...
    alpha_xy_I=3, beta_xy_I=0.5, gamma_xy_I = 1.1,
    alpha_xy_II=3, beta_xy_II=0.5, gamma_xy_II = 1.1,

    N_a = 5.0, N_b = 5.0, N_c = 1.0,
